...
const EMPLOYEE_METRIC_DESCRIPTIONS: Record<string, string> = {
  active_transaction: 'Сүүлийн 2 сард 1-2 гүйлгээтэй агентуудыг бүртгэнэ',
  ...
  resigned: 'Тухайн сард хамтран ажиллах гэрээнээ цуцалсан агентыг бүртгэнэ /Брокер эзэмшигчийн шийдвэрээр/',
  hasTopRank: 'Тухайн сард шилдэгт орсон цолтой агентыг бүртгэнэ',
  noTopRank: 'Тухайн сард шилдэгт орсон цолгүй агентыг бүртгэнэ',
};
